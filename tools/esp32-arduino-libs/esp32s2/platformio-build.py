...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "lwip", "lwip", "src", "apps", "altcp_tls"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "esp-tflite-micro"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "esp-tflite-micro", "third_party", "gemmlowp"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "esp-tflite-micro", "third_party", "flatbuffers", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "esp-tflite-micro", "third_party", "ruy"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "esp-tflite-micro", "third_party", "kissfft"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "esp-tflite-micro", "signal", "micro", "kernels"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "esp-tflite-micro", "signal", "src"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "esp-tflite-micro", "signal", "src", "kiss_fft_wrappers"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "esp-dl", "include", "tvm"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "esp-sr", "esp-tts", "esp_tts_chinese", "include"),

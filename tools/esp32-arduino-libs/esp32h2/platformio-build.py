...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "lwip", "lwip", "src", "apps", "altcp_tls"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "cbor", "port", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "rmaker_common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp_diagnostics", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "rtc_store", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp_insights", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "json_parser", "upstream", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "json_parser", "upstream"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "json_generator", "upstream"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp_schedule", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "espressif__esp_secure_cert_mgr", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp_rainmaker", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "gpio_button", "button", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "qrcode", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "ws2812_led"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp-tflite-micro"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp-tflite-micro", "third_party", "gemmlowp"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp-tflite-micro", "third_party", "flatbuffers", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp-tflite-micro", "third_party", "ruy"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp-tflite-micro", "third_party", "kissfft"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp-tflite-micro", "signal", "micro", "kernels"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp-tflite-micro", "signal", "src"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp-tflite-micro", "signal", "src", "kiss_fft_wrappers"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp_littlefs", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp32-camera", "driver", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "esp32-camera", "conversions", "include"),

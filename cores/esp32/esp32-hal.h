 ...
 * L1 cache-line size applies.  On chips without any DMA-relevant cache no
 * special alignment is needed.
 *
 * CONFIG_CACHE_L2_CACHE_LINE_SIZE and CONFIG_CACHE_L1_CACHE_LINE_SIZE are
 * generated by IDF's Kconfig system into sdkconfig.h, so this derive is
 * purely compile-time and adjusts automatically when the hardware or config
 * changes.
 */
